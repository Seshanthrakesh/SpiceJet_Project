...
public class Reports {
	...
	public void startreport() {
		try {
			sparkReports=new ExtentSparkReporter(System.getProperty("user.dir")+"/SJwebAutomationReport.html");
			sparkReports.config().setReportName("SpiceJet webAutomation Report");
