...
public class SJ5_Search_Flight_RoundTrip extends Sewrappers{
	...
	public void Search_Flight_Roundtripmethods(String origin,String dest)  {
		waitForElementToBeClickable(fligt_tab, 20);
		actionsClick(fligt_tab);
		waitForElementToBeClickable(RoundTrip_Checkbutton, 20);
		actionsClick(RoundTrip_Checkbutton);
	...
	public void passengers_count_Roundtrip() {
		waitForElementToBeClickable(Passengers_count, 20);
		actionsClick(Passengers_count);
		waitForElementToBeClickable(Adult_Increase, 20);
	...
	public void Click_SearchFlight() {
		waitForElementToBeClickable(Family_Friends,20);
		actionsClick(Family_Friends);
		waitForElementToBeClickable(SearchFlight_button,20);
